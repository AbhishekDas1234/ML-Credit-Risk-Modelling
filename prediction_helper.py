...
def prepare_df(age,income,loan_amount,loan_to_income_ratio,loan_tenure_months,avg_dpd_per_delinquency,
    ...
    input_data ={
        ...
        #add additional columns with dummy values
...
def calculate_credit_score_df(df,base_score=300,scale_length=600):
...
def predict(age, income, loan_amount, loan_to_income_ratio, loan_tenure_months, avg_dpd_per_delinquency,
                delinquency_ratio, credit_utilization_ratio,
                num_open_accounts, residence_type, loan_purpose, loan_type):
    df = prepare_df(age, income, loan_amount, loan_to_income_ratio, loan_tenure_months, avg_dpd_per_delinquency,
                delinquency_ratio, credit_utilization_ratio,
                num_open_accounts, residence_type, loan_purpose, loan_type)
    probability,credit_score,rating = calculate_credit_score_df(df)
